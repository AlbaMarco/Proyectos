...
REM build time.
IF EXIST "DocumenAPPDI.msha" COPY /Y "DocumenAPPDI.msha" HelpContentSetup.msha
...
REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale es-es /wait 0 /operation install /sourceUri "%CD%\DocumenAPPDI.msha"
